package com.classic.core.download.core;

import android.content.Context;
import android.util.Log;
import com.classic.core.download.Utils.helper.FileUtils;
import com.classic.core.download.core.chunkWorker.Moderator;
import com.classic.core.download.core.enums.QueueSort;
import com.classic.core.download.core.enums.TaskStates;
import com.classic.core.download.core.mainWorker.AsyncStartDownload;
import com.classic.core.download.core.mainWorker.QueueModerator;
import com.classic.core.download.database.ChunksDataSource;
import com.classic.core.download.database.DatabaseHelper;
import com.classic.core.download.database.TasksDataSource;
import com.classic.core.download.database.elements.Chunk;
import com.classic.core.download.database.elements.Task;
import com.classic.core.download.report.ReportStructure;
import com.classic.core.download.report.exceptions.QueueDownloadInProgressException;
import com.classic.core.download.report.exceptions.QueueDownloadNotStartedException;
import com.classic.core.download.report.listener.DownloadManagerListener;
import com.classic.core.download.report.listener.DownloadManagerListenerModerator;
import java.io.File;
...
//        dbHelper.close();
    ...
    public void init(String sdCardFolderAddress, int maxChunks, DownloadManagerListener listener){
        ...
        File saveFolder = new File(sdCardFolderAddress);
     ...
     * @throws com.classic.core.download.report.exceptions.QueueDownloadNotStartedException
     */
