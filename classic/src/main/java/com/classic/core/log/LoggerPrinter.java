...
import com.classic.core.log.utils.ArrayUtil;
import com.classic.core.log.utils.SystemUtil;
...
final class LoggerPrinter implements Printer {
     ...
     */
    @Override public void object(Object object) {
        if (object != null) {
    ...
    private int getStackOffset(StackTraceElement[] trace) {
        for (int i = MIN_STACK_OFFSET; i < trace.length; i++) {
            ...
            if (!name.equals(LoggerPrinter.class.getName()) && !name.equals(
